...
# ------------------
# Aplicar CSS con animaciones y colores según prioridad
# ------------------
...
# CSS extra para tarjetas y hover animado
st.markdown("""
<style>
.task-card {
    padding: 12px;
...
def priority_class(p):
    return f"priority-{p}" if p in [1,2,3,4,5] else "priority-3"

# ------------------
# Sidebar con iconos grandes
# ------------------
